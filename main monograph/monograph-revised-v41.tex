...
\begin{proof}
Weak König's lemma gives a path through the tree of coherent finite choices,
...
The table separates input-uniform Weihrauch classification from nonuniform oracle
spectra. The realisation theorem above is the nonuniform counterpart of the WKL
...
algorithmic monograph. A module may move from this ledger into the theorem body
...
monograph supplies the invariants and transport vocabulary; the companion finite
monograph supplies the input format, verifier grammar, algorithms, and mechanics
front end. In particular, a finite solver returning a timeout supplies no ECD
...
\begin{remark}
The results in this section develop the companion programme at the level of
specified isomorphisms, fixed-base morphisms, and compositional operations with
