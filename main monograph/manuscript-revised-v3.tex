...
global families are subsets of one ambient family space. The descent kernel contains ordinary restriction agreement; arbitrary relational
compatibility belongs to separate constraint extensions.
...
In Theorem~\ref{thm:nested-WKL}, the tree itself is represented input and may
be noncomputable.
...
space of policies consistent with all worlds in $W'$. This polarity is distinct from observational equivalence classes.
\end{remark}
