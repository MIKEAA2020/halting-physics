...
compositional extension theory. The finite algorithmic realization --- input
...
Weihrauch degrees, and a \(\Sigma^0_3\)-complete
...
to the companion algorithmic monograph, which realizes it in typed
...
algorithmic monograph (version~11, with its artifact appendix, version~8).
...
but not a claim of practical superiority over SAT, CP-SAT, MILP, or other
baselines.
\end{remark}
...
\begin{remark}
The results in this section develop the companion algorithmic programme at
...
duplicated: the companion algorithmic monograph (version~11, with its
artifact appendix, version~8) supplies the input format, typed certificate
