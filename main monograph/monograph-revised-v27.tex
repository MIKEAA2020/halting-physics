...
\begin{remark}[Noninvertible empirical maps]
For noninvertible maps there is no single canonical preservation theorem. Direct
image, inverse image, and saturation of supports have different variances and
preserve different facts. Coarse-graining can create global sections and erase a
contextuality witness; inverse-image constructions can reflect rather than
preserve contextuality. The operation must therefore be declared before any
noninvertible functoriality claim is meaningful.
\end{remark}
...
Protocol complexes & representation target & chromatic complexes, carrier maps, process model, and protocol legality\\
