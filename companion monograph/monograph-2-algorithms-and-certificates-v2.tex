...
The current artifact includes explicit-table solving, tree-decomposition DP
...
A compact verification table from the current gate is as follows.
\begin{center}
...
Controlled-width benchmark families currently include paths, binary trees,
...
\input{companion-artifact-appendix-v1.tex}
