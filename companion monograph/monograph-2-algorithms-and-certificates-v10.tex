...
\((1,0)\), whose charge is \(\kappa_1=\kappa_{x_1}(1)=1\), and when
...
two loads share one information state, and the shared fibre is exactly the
minimal conflict core.  What the refutation certificate certifies is
...
Figure~\ref{fig:mechanics-families}(a) sketches the arrangement.
...
quantized tip loads, and member forces are monitored.
...
and the two quantized loads act at the free-edge corners.
