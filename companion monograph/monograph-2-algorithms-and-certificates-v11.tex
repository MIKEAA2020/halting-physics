...
descent (ECD).  The foundational monograph (version~44) supplies the presentation-relative
...
inclusion-minimal conflict cores.  Sixth, we connect exact affine mechanical
...
phase labels follow the artifact's recorded build phases.
\begin{center}
...
\input{companion-artifact-appendix-v8.tex}
